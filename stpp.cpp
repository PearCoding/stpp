...
bool binary_condition(Lexer& lexer, const Context& ctx);
bool primary_condition(Lexer& lexer, const Context& ctx)
{
...
bool unary_condition(Lexer& lexer, const Context& ctx)
{
